...
namespace RPGMaker.Codebase.Runtime.Common
{
    public class TextManager {
        ...
        public static string gameEndExecute =>
            WordDefinitionDataModel.commands.gameEndExecute.enabled == 1
                    ? WordDefinitionDataModel.commands.gameEndExecute.value
                    : WordDefinitionDataModel.commands.gameEndExecute.initialValue;
