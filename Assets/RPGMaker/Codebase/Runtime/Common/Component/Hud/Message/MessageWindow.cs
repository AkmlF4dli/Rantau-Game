...
#else
        public async Task ShowFaceIcon(string iconPath) {
#endif
...
#else
            _ = _controlCharacterName.ExecCharacterByName();
#endif
        }
...
#else
        public async Task ShowPicture(string pictureName) {
#endif
