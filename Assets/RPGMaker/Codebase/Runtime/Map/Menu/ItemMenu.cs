...
namespace RPGMaker.Codebase.Runtime.Map.Menu
{
    public class ItemMenu : WindowBase
    {
        ...
        public async Task UpdateStatus() {
            await MenusEventAsync(_nowMenu);
        }
#endif
...
#else
                    await _itemsItem.Init(runtimeSaveDataModel.runtimePartyDataModel.items[i].itemId,
#endif
...
#else
                await _itemsItem.Init("", "", "", this, null, CloseParty);
#endif
                _itemsItems.Add(_itemsItem);
            }
...
#else
                    await _itemsItem.Init(runtimeSaveDataModel.runtimePartyDataModel.weapons[i].weaponId,
#endif
...
#else
                    await _itemsItem.Init(runtimeSaveDataModel.runtimePartyDataModel.armors[i].armorId,
#endif
