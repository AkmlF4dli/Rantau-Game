...
namespace RPGMaker.Codebase.CoreSystem.Knowledge.DataModel.EventCommon
{
    ...
    public class EventCommonDataModel : WithSerialNumberDataModel
    {
        ...
        public EventCommonDataModel Clone() {
            var eventCommonDataModelClone = (EventCommonDataModel) MemberwiseClone();
            //U387 参照を切りメンバーをコピーする
            eventCommonDataModelClone.conditions = new List<EventCommonCondition>(conditions);
            return eventCommonDataModelClone;
        }
