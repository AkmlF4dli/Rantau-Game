...
namespace RPGMaker.Codebase.CoreSystem.Knowledge.DataModel.WordDefinition
{
    [Serializable]
#if UNITY_EDITOR
    public class WordDefinitionDataModel : ISerializationCallbackReceiver
#else
...
#endif
    {
        ...
        public class Commands
        {
            ...
            public WordItem gameEndExecute;
            ...
            public WordItem GameEndExecute => gameEndExecute;
        ...
        public void OnAfterDeserialize() {
            if (commands.gameEndExecute.initialValue == null)
            {
                commands.gameEndExecute = new WordItem(1, CoreSystemLocalize.LocalizeText("WORD_3105"), CoreSystemLocalize.LocalizeText("WORD_3105"));
            }
        }
#endif
    }
